...
//mycompany.sleepservice
jint Java_mycompany_sleepservice_Events_intEnableDebug( JNIEnv* env,jobject thiz, jint enable ) {
...
jint Java_mycompany_sleepservice_Events_intSendEvent(JNIEnv* env,jobject thiz, jint index, uint16_t type, uint16_t code, int32_t value) {
...
jint Java_mycompany_sleepservice_Events_ScanFiles( JNIEnv* env,jobject thiz ) {
...
jstring Java_mycompany_sleepservice_Events_getDevPath( JNIEnv* env,jobject thiz, jint index) {
	if(pDevs[index].device_path == NULL)
		return (*env)->NewStringUTF(env, "null");
	if(strlen(pDevs[index].device_path)<4)
		return (*env)->NewStringUTF(env, "null");
	return (*env)->NewStringUTF(env, pDevs[index].device_path);
}
jstring Java_mycompany_sleepservice_Events_getDevName( JNIEnv* env,jobject thiz, jint index) {
	if (pDevs[index].device_name == NULL)
		return (*env)->NewStringUTF(env, "null");
	if(strlen(pDevs[index].device_name)<4)
		return (*env)->NewStringUTF(env, "null");
	return (*env)->NewStringUTF(env, pDevs[index].device_name);
}

jint Java_mycompany_sleepservice_Events_OpenDev( JNIEnv* env,jobject thiz, jint index ) {
	return open_device(index);
}

jint Java_mycompany_sleepservice_Events_RemoveDev( JNIEnv* env,jobject thiz, jint index ) {
	return remove_device(index);
}

jint Java_mycompany_sleepservice_Events_PollDev( JNIEnv* env,jobject thiz, jint index ) {
	if (index >= nDevsCount || pDevs[index].ufds.fd == -1) return -1;
...
jint Java_mycompany_sleepservice_Events_getType( JNIEnv* env,jobject thiz ) {
	return event.type;
}

jint Java_mycompany_sleepservice_Events_getCode( JNIEnv* env,jobject thiz ) {
	return event.code;
}

jint Java_mycompany_sleepservice_Events_getValue( JNIEnv* env,jobject thiz ) {
	return event.value;
}